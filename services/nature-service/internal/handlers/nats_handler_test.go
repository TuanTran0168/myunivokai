...
func TestPublishCompositionFailureUsesNatureContract(t *testing.T) {
	...
	if publisher.message.Subject != contracts.NatureFailedEventSubject {
	...
	if failure.Data.Family != contracts.WorldFamilyNature || failure.Data.ProfileID != "profile-1" {

...
type ResponseValidator func(json.RawMessage) (models.NatureDNA, error)
...
// retry, and fallback inside one GenerateNatureDNA run. Without a cap the
...
func (o *Orchestrator) GenerateNatureDNA(ctx context.Context, req StructuredRequest) (*DNAResult, error) {
	if o.primary == nil {

...
// nature-service's copy of it.
const snapshotFamily = contracts.WorldFamilyUniverse
...
func newWorldSnapshot(world models.World, variantCount, selectedVariantNo int, publishedAt *time.Time) contracts.WorldSnapshot {
	...
	return contracts.WorldSnapshot{
		...
		TraitScores: contracts.TraitScores{
			Creativity: world.PersonalityDNA.TraitScores.Creativity,
			Discipline: world.PersonalityDNA.TraitScores.Discipline,
			Curiosity:  world.PersonalityDNA.TraitScores.Curiosity,
			Energy:     world.PersonalityDNA.TraitScores.Energy,
			Focus:      world.PersonalityDNA.TraitScores.Focus,
		},

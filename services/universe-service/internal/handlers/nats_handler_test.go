...
func TestPublishCompositionFailureUsesUniverseContract(t *testing.T) {
	...
	if publisher.message.Subject != contracts.UniverseFailedEventSubject {
	...
	if failure.Data.Family != contracts.WorldFamilyUniverse || failure.Data.ProfileID != "profile-1" {

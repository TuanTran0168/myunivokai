...
pub use telemetry::{
    ...
    TelemetryCacheSummary, TelemetryErrorCodeCount, TelemetryHistogram,
    ...
    TelemetryStatusClassCount, TelemetryVolumePoint, TELEMETRY_DEFAULT_HOURS,
    TELEMETRY_HISTOGRAM_BUCKET_COUNT, TELEMETRY_HISTOGRAM_UPPER_BOUNDS_MS,
    TELEMETRY_HTTP_ROLLUP_EVENT_SUBJECT, TELEMETRY_MAXIMUM_HOURS,
    TELEMETRY_OVERVIEW_GET_QUERY_SUBJECT, TELEMETRY_ROUTE_LIST_QUERY_SUBJECT,
    TELEMETRY_SINK_OTLP, TELEMETRY_SINK_POSTGRES, TELEMETRY_STATUS_CLASS_MAXIMUM,
    TELEMETRY_STATUS_CLASS_MINIMUM,
};

...
// its own — see notes/vision/auth-and-admin-plan.md#amended--dynamic-modelled-on-django-auth.
...
// notes/vision/auth-and-admin-plan.md#how-b-works describes for the

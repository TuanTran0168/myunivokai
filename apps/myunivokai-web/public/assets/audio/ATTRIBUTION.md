...
transparent within a few semitones — that is why a whole orchestra of seven
...
Source files are 44.1–48 kHz, 16- or 24-bit stereo WAV, 0.5–3.5 MB each — 58.7 MB
for the 36 taken. Each was:
...
3. trimmed of leading silence, cut to 3–5 s depending on how long the instrument
   naturally rings, and faded out over 600 ms;
...
Result: **36 files, 1.13 MB.** For comparison the solar-system textures alone are
30 MB.

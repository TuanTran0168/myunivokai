    ...
    <html lang="en" className={`${inter.variable} ${spaceGrotesk.variable} ${jetBrainsMono.variable}`}>
      <body>
        <div className="relative flex min-h-screen flex-col">
          ...
          <header className="fixed top-0 z-50 w-full border-b border-white/10 bg-mount/60 shadow-[0_1px_0_0_rgba(201,163,91,0.22)] backdrop-blur-xl">
          ...
          <footer className="relative z-10 mt-auto border-t border-white/10 bg-void/70 shadow-[0_-1px_0_0_rgba(201,163,91,0.15)] backdrop-blur-sm">

...
| [vision/ocean-service-plan.md](vision/ocean-service-plan.md) | **Approved design, not yet built.** The decided Ocean family: the specified depth curve and its tests, the platform seam inventory including what needs no change, the frontend preview builder the City plan omits, phases O0–O6, branch sequence | Before any Ocean contract, BE, gateway, asset or FE branch |

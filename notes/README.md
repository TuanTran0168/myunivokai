...
| [vision/ocean-family-research.md](vision/ocean-family-research.md) | **Research, not approved.** Ocean as the third family: depth as the scene axis backed by measured light attenuation, the section-by-section mirror of `ForestSceneConfig`, the reuse inventory read file by file, verified CC0 assets/public-domain audio, and the licence wall that re-scopes City | Before choosing between Ocean and City, or before any deep-sea asset, contract or renderer branch |

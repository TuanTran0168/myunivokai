...
Pending verification: Docker Desktop engine was unavailable during this source
review, so fresh-volume startup, health, and end-to-end container smoke remain
unchecked rather than inferred.

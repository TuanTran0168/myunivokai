...
([service-wake-mechanism.md](../../vision/service-wake-mechanism.md)) is
explicitly out of this sprint; see §Known accepted risk.

Backlog epics:
[EPIC-S4-AUTH-001](../../user-stories/engineering-backlog.md#epic-s4-auth-001--staff-identity-and-the-internal-admin-app),
[EPIC-S4-ANALYTICS-001](../../user-stories/engineering-backlog.md#epic-s4-analytics-001--a-read-model-for-the-admin-app)

Sprint stories: [user-stories.md](user-stories.md)

Plans this sprint executes:
[auth-and-admin-plan.md](../../vision/auth-and-admin-plan.md),
[analytics-service-plan.md](../../vision/analytics-service-plan.md)
...
[§Changes this forces in auth-and-admin-plan.md](../../vision/analytics-service-plan.md#changes-this-forces-in-auth-and-admin-planmd).
...
[analytics-service-plan.md's open decision 4](../../vision/analytics-service-plan.md#open-decisions-for-the-owner)
...
fully designed in
[service-wake-mechanism.md](../../vision/service-wake-mechanism.md) and stays
out of scope here.
